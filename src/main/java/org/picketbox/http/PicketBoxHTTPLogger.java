 ...
 * @since Jul 10, 2012
 */
@MessageLogger(projectCode = "PBOXHTTP")
public interface PicketBoxHTTPLogger extends BasicLogger {

    PicketBoxHTTPLogger LOGGER = Logger.getMessageLogger(PicketBoxHTTPLogger.class, PicketBoxHTTPLogger.class.getPackage()
            .getName());
